...
/*
** if (entity->dist_to_player < dist_to_wall) technically compares the distance
** to the center of the entity, instead of the distance to the ray collision,
** but it's close enough for all practical purposes.
*/
